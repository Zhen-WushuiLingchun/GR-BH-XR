...
The repository suite passed `214` tests on 2026-08-06 after the Task 9/10
baseline was fast-forwarded to `main` and complete Unity `.meta` coverage was
restored.
...
- NPGS fork, pinned submodule, clean baseline build, and performance capture.
